...
const PUBLIC_PATHS = ['/login', '/register', '/auth/callback', '/auth/confirm', '/', '/favicon.ico', '/sitemap-contenus', '/sitemap.xml', '/jeune-intermittent-16-8', '/jeune-intermittent-perte-de-poids', '/newsfeed', '/api/healthcheck-pages']
